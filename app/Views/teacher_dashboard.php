...
<head>
    ...
    <title><?= esc($title ?? 'Teacher Dashboard') ?></title>
...
<body>
    <div class="welcome-card">
        <i class="bi bi-person-badge welcome-icon"></i>
        <h1>Welcome, Teacher!</h1>
        <p class="lead">You have successfully logged in to the Teacher Dashboard</p>
        ...
        <div class="user-info">
            ...
            <p class="mb-0"><strong><i class="bi bi-shield"></i> Role:</strong> <span class="badge bg-success"><?= esc(ucfirst($role)) ?></span></p>
        </div>
